...
public class Ejercicio236 {
    public static void main(String[] args) {
        ...
        do {
            System.out.println("Ingresa dos numero para imprimir los numeros pares desde el primero al segundo");
        ...
        System.out.println("numero pares desde "+num1+ " hasta "+num2);
